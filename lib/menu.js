...
function helpCaption(maxFileSizeMB) {
  return (
    ...
    "• File hasil download nampilin caption detail: nama akun, like/view/comment, cuplikan deskripsi & hashtag postingan asli (kalau datanya ada dari platform aslinya)\n" +
    ...
    "<code>/caption</code> — nyala/matiin caption detail (akun, like/view, deskripsi, hashtag)\n" +
